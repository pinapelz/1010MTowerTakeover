...
*/
  ...
  strafeRight(75,460,800); //Use the mecanum wheels to move right
  driveForwardSecOne(60,100, 300);//Drive forward and intake the cube under the tower
  driveBackward(60, 100, 300); //Back away from the tower
  driveRight(75, 880, 1200); //Turn so that the intake points to the
  driveForward(60,900,2000); 
  strafeLeft(60,500,500);
  driveForward(50, 300, 350);
  placeCubes();  //The code will only keep going after this had finished
  driveBackward(50, 200, 500); 
}
void pre_auton(void) {}
