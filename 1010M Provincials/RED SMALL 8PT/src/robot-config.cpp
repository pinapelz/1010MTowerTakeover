...
sonar UltraLeft = sonar(Brain.ThreeWirePort.A);
sonar UltraRight = sonar(Brain.ThreeWirePort.C);
bumper ScoringBump = bumper(Brain.ThreeWirePort.E);
limit StackSwitch = limit(Brain.ThreeWirePort.F);
